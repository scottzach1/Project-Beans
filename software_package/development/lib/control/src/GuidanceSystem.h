#ifndef SOFTWARE_PACKAGE_DEVELOPMENT_LIB_CONTROL_SRC_GUIDANCESYSTEM_H_
#define SOFTWARE_PACKAGE_DEVELOPMENT_LIB_CONTROL_SRC_GUIDANCESYSTEM_H_
...
#endif  // SOFTWARE_PACKAGE_DEVELOPMENT_LIB_CONTROL_SRC_GUIDANCESYSTEM_H_
